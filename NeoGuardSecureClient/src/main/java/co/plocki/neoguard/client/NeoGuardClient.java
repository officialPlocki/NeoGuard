...
public class NeoGuardClient {
    ...
    public void start() throws IOException, KeyManagementException, NoSuchAlgorithmException {
        ...
        sslContext.init(null, new TrustManager[]{new NeoGuardClient.TrustAllManager()}, null);
        HttpsURLConnection.setDefaultSSLSocketFactory(sslContext.getSocketFactory());
        HttpsURLConnection.setDefaultHostnameVerifier(new NeoGuardClient.TrustAllHostnameVerifier());
